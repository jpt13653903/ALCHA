...
" Keywords
syn match AlchaKeyword "\<\(target\|void\|auto\|pin\|sig\|clk\|int\|rat\|float\|complex\|in\|out\|signed\|class\|if\|else\|for\|while\|loop\|switch\|case\|default\|import\|as\|return\|break\|continue\|rtl\|fsm\|hdl\)\>"
