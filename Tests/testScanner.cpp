...
bool testKeywords()
{
    ...
    Expected expected[] = {
        ...
        { 45, Token::Type::Func,       0, "func"       },
        { 46, Token::Type::Inline,     0, "inline"     },
        { 47, Token::Type::Operator,   0, "operator"   },
        { 49, Token::Type::RTL,        0, "rtl"        },
        { 50, Token::Type::FSM,        0, "fsm"        },
        { 51, Token::Type::HDL,        0, "hdl"        },
        { 53, Token::Type::Stimulus,   0, "stimulus"   },
        { 54, Token::Type::Emulate,    0, "emulate"    },
        { 55, Token::Type::Sequence,   0, "sequence"   },
        { 56, Token::Type::Assert,     0, "assert"     },
        { 57, Token::Type::Wait,       0, "wait"       },
        { 59, Token::Type::PosEdge,    0, "posedge"    },
        { 60, Token::Type::NegEdge,    0, "negedge"    },
        { 62, Token::Type::CoverBins,  0, "coverbins"  },
        { 63, Token::Type::CoverGroup, 0, "covergroup" },
        { 63, Token::Type::EndOfFile,  0, ""           }
    };
