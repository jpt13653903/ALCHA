...
AndAssign::AndAssign(int line, std::string filename):
    AndAssign(line, filename.c_str()){}
//------------------------------------------------------------------------------
...
Base* AndAssign::copy()
{
    AndAssign* copy = new AndAssign(source.line, source.filename.c_str());
...
bool AndAssign::runAST()
{
    ...
    // Move the expression
    Expression* expression = new BitAnd(right->source.line, right->source.filename);
...
bool AndAssign::getVerilog(string& body)
{
