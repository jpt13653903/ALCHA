...
SHIFT_RIGHT_ASSIGN::SHIFT_RIGHT_ASSIGN(int Line, std::string Filename):
SHIFT_RIGHT_ASSIGN(Line, Filename.c_str()){}
//------------------------------------------------------------------------------

SHIFT_RIGHT_ASSIGN::SHIFT_RIGHT_ASSIGN(int Line, const char* Filename):
...
BASE* SHIFT_RIGHT_ASSIGN::Copy(bool CopyNext){
  SHIFT_RIGHT_ASSIGN* Copy = new SHIFT_RIGHT_ASSIGN(Source.Line, Source.Filename.c_str());
...
bool SHIFT_RIGHT_ASSIGN::RunAST(){
  ...
  // Move the expression
  EXPRESSION* Expression = new SHIFT_RIGHT(Right->Source.Line, Right->Source.Filename);
...
bool SHIFT_RIGHT_ASSIGN::GetVerilog(string& Body){
  error("Not yet implemented");
  return false;
}
//------------------------------------------------------------------------------

void SHIFT_RIGHT_ASSIGN::Display(){
  DisplayAssignment("<<=");
}
//------------------------------------------------------------------------------

void SHIFT_RIGHT_ASSIGN::ValidateMembers(){
