...
ShiftRightAssign::ShiftRightAssign(int line, std::string filename):
    ShiftRightAssign(line, filename.c_str()){}
//------------------------------------------------------------------------------
...
Base* ShiftRightAssign::copy()
{
    ShiftRightAssign* copy = new ShiftRightAssign(source.line, source.filename.c_str());
...
bool ShiftRightAssign::runAST()
{
    ...
    // Move the expression
    Expression* expression = new ShiftRight(right->source.line, right->source.filename);
...
bool ShiftRightAssign::getVerilog(string& body)
{
