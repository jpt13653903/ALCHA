...
Base* ShiftLeftAssign::copy()
{
    ShiftLeftAssign* copy = new ShiftLeftAssign(source.line, source.filename.c_str());
...
bool ShiftLeftAssign::runAST()
{
    ...
    // Move the expression
    Expression* expression = new ShiftLeft(right->source.line, right->source.filename);
...
bool ShiftLeftAssign::getVerilog(string& body)
{
...
void ShiftLeftAssign::display()
{
    displayAssignment("<<=");
}
//------------------------------------------------------------------------------

void ShiftLeftAssign::validateMembers()
{
    assert(type == Type::ShiftLeftAssign);
