...
Base* XorAssign::copy()
{
    XorAssign* copy = new XorAssign(source.line, source.filename.c_str());
...
bool XorAssign::runAST()
{
    ...
    // Move the expression
    Expression* expression = new BitXor(right->source.line, right->source.filename);
...
bool XorAssign::getVerilog(string& body)
{
