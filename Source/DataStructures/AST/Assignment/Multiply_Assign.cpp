...
MULTIPLY_ASSIGN::MULTIPLY_ASSIGN(int Line, std::string Filename):
MULTIPLY_ASSIGN(Line, Filename.c_str()){}
//------------------------------------------------------------------------------

MULTIPLY_ASSIGN::MULTIPLY_ASSIGN(int Line, const char* Filename):
...
bool MULTIPLY_ASSIGN::GetVerilog(string& Body){
  error("Not yet implemented");
  return false;
}
//------------------------------------------------------------------------------

void MULTIPLY_ASSIGN::Display(){
  DisplayInfo();
  ...
  switch(Type){
    case TYPE::Multiply_Assign   : Debug.Print( " *= "); break;
