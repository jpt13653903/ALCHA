...
Base* SubtractAssign::copy()
{
    SubtractAssign* copy = new SubtractAssign(source.line, source.filename.c_str());
...
bool SubtractAssign::getVerilog(string& body)
{
