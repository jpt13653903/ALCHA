...
Base* OrAssign::copy()
{
    OrAssign* copy = new OrAssign(source.line, source.filename.c_str());
...
bool OrAssign::runAST()
{
    ...
    // Move the expression
    Expression* expression = new BitOr(right->source.line, right->source.filename);
...
bool OrAssign::getVerilog(string& body)
{
