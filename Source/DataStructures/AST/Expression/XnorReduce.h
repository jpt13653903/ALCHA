...
#ifndef AST_Expression_XnorReduce_h
#define AST_Expression_XnorReduce_h
//------------------------------------------------------------------------------
...
namespace AST{
    struct XnorReduce: public Expression{
        XnorReduce(int line, const std::string& filename);
        XnorReduce(int line, const char*        filename);
       ~XnorReduce();
