...
#ifndef AST_Expression_BitNor_h
#define AST_Expression_BitNor_h
//------------------------------------------------------------------------------
...
namespace AST{
    struct BitNor: public Expression{
        BitNor(int line, const std::string& filename);
        BitNor(int line, const char*        filename);
       ~BitNor();
