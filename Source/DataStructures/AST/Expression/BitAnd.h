...
#ifndef AST_Expression_Bit_AND_h
#define AST_Expression_Bit_AND_h
//------------------------------------------------------------------------------
...
namespace AST{
    struct BitAnd: public Expression{
        BitAnd(int line, const std::string& filename);
        BitAnd(int line, const char*        filename);
       ~BitAnd();
