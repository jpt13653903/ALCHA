...
#ifndef AST_Expression_OR_Reduce_h
#define AST_Expression_OR_Reduce_h
//------------------------------------------------------------------------------
...
namespace AST{
    struct OrReduce: public Expression{
        OrReduce(int line, const std::string& filename);
        OrReduce(int line, const char*        filename);
       ~OrReduce();
