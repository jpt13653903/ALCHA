...
#ifndef AST_Expression_AccessMemberSafe_h
...
namespace AST{
  struct ACCESSMEMBERSAFE: public EXPRESSION{
    ACCESSMEMBERSAFE(int Line, const std::string& Filename);
    ACCESSMEMBERSAFE(int Line, const char*        Filename);
   ~ACCESSMEMBERSAFE();
