...
#ifndef AST_Expression_Equal_h
#define AST_Expression_Equal_h
//------------------------------------------------------------------------------
...
namespace AST{
    struct EQUAL: public EXPRESSION{
        EQUAL(int Line, const std::string& Filename);
        EQUAL(int Line, const char*        Filename);
      ~EQUAL();
