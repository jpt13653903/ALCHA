...
#ifndef AST_Expression_Bit_OR_h
#define AST_Expression_Bit_OR_h
//------------------------------------------------------------------------------
...
namespace AST{
    struct BIT_OR: public EXPRESSION{
        BIT_OR(int Line, const std::string& Filename);
        BIT_OR(int Line, const char*        Filename);
      ~BIT_OR();
