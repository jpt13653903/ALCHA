...
pin_group<direction = "in"> U20_{
 pin_group<voltage = "2.5 V"> CLOCK{
 ...
 pin_array<voltage = "1.5 V", standard = "PCML"> REFCLK{
...
pin_group<voltage = "2.5 V"> UART_{
 pin<direction = "out", number = "L9"> TX;
 pin<direction = "in" , number = "M9"> RX;
}

pin_group<voltage = "3.3 V"> SRAM_{
 pin_array<direction = "out"> A{
  pin[ 0]<number = "B25">;
  pin[ 1]<number = "B26">;
  pin[ 2]<number = "H19">;
  pin[ 3]<number = "H20">;
...
pin_group<voltage = "1.2 V"> DDR2LP_{
 pin_array<direction = "out", standard = "HSUL"> CA{
  pin[0]<number = "AE6" >;
  pin[1]<number = "AF6" >;
  pin[2]<number = "AF7" >;
  pin[3]<number = "AF8" >;
 ...
 pin<
  ...
  pair      = "P10"
 > CK;
 pin_array<direction = "out", standard = "HSUL"> CKE{
  pin[0]<number = "AF14">;
  pin[1]<number = "AE13">;
 }
 pin_array<direction = "out", standard = "HSUL"> CS_n{
  pin[0]<number = "R11">;
  pin[1]<number = "T11">;
 }
 pin<standard = "HSUL", number = "AE11"> OCT_RZQ;
}

pin_group<voltage = "3.3 V", min_delay = "500 ps", max_delay = "1 ns"> SD_{
 pin     <direction = "out", number = "AB6"> CLK;
 pin     <                   number = "W8" > CMD;
 pin_array DAT{
  pin[0]<number = "U7">;
  pin[1]<number = "T7">;
...
pin_group HDMI_TX_{
 pin_array<direction = "out", voltage = "3.3 V"> D{
  pin[ 0]<number =  "V23">;
  pin[ 1]<number = "AA26">;
  pin[ 2]<number =  "W25">;
  pin[ 3]<number =  "W26">;
 ...
 pin<direction = "out", voltage = "3.3 V", number = "Y25"> CLK;
 pin<direction = "out", voltage = "3.3 V", number = "Y26"> DE;
 pin<direction = "out", voltage = "3.3 V", number = "U26"> HS;
 pin<direction = "out", voltage = "3.3 V", number = "U25"> VS;
 pin<direction = "in" , voltage = "1.2 V", number = "T12"> INT;
}

pin_group<voltage = "2.5 V"> AUD_{
 pin<                   number = "C7" > ADCLRCK;
 pin<direction = "in" , number = "D7" > ADCDAT;
 pin<                   number = "G10"> DACLRCK;
 pin<direction = "out", number = "H10"> DACDAT;
 pin<direction = "out", number = "D6" > XCK;
 pin<                   number = "E6" > BCLK;
}

pin_group HSMC_{
 pin_group<voltage = "2.5 V"> CLK{
  pin_group IN_{
  <pin_array> {
 ...
 pin_array<voltage = "2.5 V"> D{
  pin[0]<number = "D11">;
  pin[1]<number = "H14">;
  pin[2]<number = "D12">;
  pin[3]<number = "H13">;
 }
 pin_group<voltage = "1.5 V", standard = "PCML"> GXB_{
  pin_array<direction = "in"> RX{
   pin[0]<number = "AD2", pair = "AD1">;
   pin[1]<number = "AB2", pair = "AB1">;
   pin[2]<number = "Y2" , pair = "Y1" >;
   pin[3]<number = "V2" , pair = "V1" >;
  }
  pin_array<direction = "out"> TX{
...
pin_group<voltage = "3.3 V"> Arduino_{
 pin_array IO{
  pin[ 0]<number = "E26">;
  pin[ 1]<number = "K26">;
  pin[ 2]<number = "M26">;
 ...
 pin<direction = "in", number = "AB24"> Reset_n;
}

pin_group<voltage = "1.2 V"> ADC_{
 pin<direction = "out", number = "AB22"> CONVST;
 pin<direction = "out", number = "AA21"> SCK;
 pin<direction = "out", number =  "Y10"> SDI;
 pin<direction = "in" , number =  "W10"> SDO;
}
//------------------------------------------------------------------------------
