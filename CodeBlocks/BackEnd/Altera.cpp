...
bool ALTERA::WriteProject(){
 ...
 QSF <<
  ...
  "set_global_assignment -name "
  "INTERNAL_FLASH_UPDATE_MODE \"SINGLE COMP IMAGE\"\n"
  "#----------------------------------------"
  "---------------------------------------\n"
  "\n";
 QSF <<
  ...
  "\n";
 QSF <<
  "set_global_assignment -name SDC_FILE " << hdl.Files->Name << ".sdc\n"
  "set_global_assignment -name CDF_FILE " << hdl.Files->Name << ".cdf\n";
 HDL::FILE* File = hdl.Files;
 while(File){
  QSF << "set_global_assignment -name VERILOG_FILE " << File->Name << ".v\n";
  File = File->Next;
 }
 QSF <<
  "#----------------------------------------"
 ...
 CDF <<
  ...
  "  Device PartName(" <<
  Target.Device <<
  ") Path(\"output_files/\") File(\"" <<
  hdl.Files->Name << ".sof\") MfrSpec(OpMask(1));\n"
  "\n"
  "ChainEnd;\n"
  "\n"
  "AlteraBegin;\n"
