...
////------------------------------------------------------------------------------
//
//void PREPROCESSOR::Error(const byte* Message){
// error = true;
// printf(
//  "Line %05d of %s\n  Error: %s\n",
//  ppToken.Line,
...
////------------------------------------------------------------------------------
//
//bool PREPROCESSOR::Open(const byte* Filename){
// SCANNER_STACK* Temp;
// while(Scanner_Stack){
//  Temp          = Scanner_Stack;
//  Scanner_Stack = Scanner_Stack->Next;
...
//// const byte* Buffer = ppToken.Body.String() + 2;
////
//// Number = 0;
////
//// while(*Buffer){
...
//// const byte* Buffer = ppToken.Body.String();
////
//// Number = 0;
////
//// while(*Buffer){
